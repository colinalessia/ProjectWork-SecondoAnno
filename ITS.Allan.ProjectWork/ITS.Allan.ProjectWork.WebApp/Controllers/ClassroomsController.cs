...
namespace ITS.Allan.ProjectWork.WebApp.Controllers
{
    ...
    public class ClassroomsController : ControllerBase
    {
        ...
        public ClassroomsController(UniBookContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Classroom>> PostClassroom(Classroom classroom)
        {
            ...
            return CreatedAtAction("GetClassroom", new { id = classroom.IdClassroom }, classroom);
        }
        ...
        {
            return _context.Classrooms.Any(e => e.IdClassroom == id);
        }
    }
}
